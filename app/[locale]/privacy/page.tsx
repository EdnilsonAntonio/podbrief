            ...
            <CardContent className="pt-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  {" "}or visit our{" "}
                  <Link href={`/${locale}/$1`} className="text-primary hover:underline">
                    contact page
                  </Link>.
                </p>
              </div>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href={`/${locale}/$1`} className="hover:text-foreground">Pricing</Link></li>
                <li><Link href={`/${locale}/$1`} className="hover:text-foreground">Dashboard</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-4">Company</h3>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href={`/${locale}/$1`} className="hover:text-foreground">About</Link></li>
                <li><Link href={`/${locale}/$1`} className="hover:text-foreground">Contact</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-4">Legal</h3>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href={`/${locale}/$1`} className="hover:text-foreground">Privacy Policy</Link></li>
                <li><Link href={`/${locale}/$1`} className="hover:text-foreground">Terms of Service</Link></li>
              </ul>
            </div>
          </div>
